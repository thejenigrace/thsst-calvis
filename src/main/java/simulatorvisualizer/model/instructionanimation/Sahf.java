...
public class Sahf extends CalvisAnimation {
    ...
    public void animate(ScrollPane tab) {
        ...
        // CODE HERE
        Text description = new Text("The values of bit 0, 2, 4, 6 and 7 of AH are transferred to carry, parity, auxiliary, zero and sign flag, respectively. \n" +
                "Affected flags: SF, AF, PF, CF, ZF\n\n" +
                "Below is the binary representation of the value of register AH:");
