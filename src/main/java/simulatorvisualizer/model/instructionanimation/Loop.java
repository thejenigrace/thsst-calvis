...
import simulatorvisualizer.model.JumperFunction;
 ...
 */
public class Loop extends CalvisAnimation {
    ...
    public void animate(ScrollPane tab) {
        ...
        conditionVal.setWrappingWidth(fromRec.getLayoutBounds().getWidth() - 40);
        ...
        conditioLabelnVal.setWrappingWidth(labelRec.getLayoutBounds().getWidth() - 30);
