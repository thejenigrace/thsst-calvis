 ...
 */
public class Movupd extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        for(int x = 0; x < (size/2) / 2; x = x + operationSize){
            ...
            dividedSinglePresNum += c.hexToDoublePrecisionFloatingPoint(extractedHex) + "      ";
            duplicatedividedSinglePresNum += c.hexToDoublePrecisionFloatingPoint(extractedHex) + "      ";
        }
