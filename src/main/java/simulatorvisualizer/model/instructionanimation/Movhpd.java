 ...
 */
public class Movhpd extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        for(int x = 0; x < (size/2) / 2; x = x + operationSize){
            ...
            dividedSinglePresNum += c.hexToDoublePrecisionFloatingPoint(extractDes) + "      ";
            duplicatedividedSinglePresNum += c.hexToDoublePrecisionFloatingPoint(extractDes) + "      ";
        }
        ...
        Text srcLabel = new Text("High Quad-Word of " + this.createLabelText(src).getText());
