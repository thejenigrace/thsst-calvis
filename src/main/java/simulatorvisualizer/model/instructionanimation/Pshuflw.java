 ...
 */
public class Pshuflw extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        Rectangle desRec = this.createRectangle(des, 260, 80);
        Rectangle srcRec = this.createRectangle(src, 260, 165);
        ...
        Text zeroExtended = new Text(this.createLabelText(des).getText() + "[16 to 31] <- Retain: " + desStr.substring(0, 16));
        Text desFirstWord = new Text(this.createLabelText(des).getText() + "[12 to 15] <- " + desStr.substring(16, 20));
        Text desSecondWord = new Text(this.createLabelText(des).getText() + "[8 to 11] <- " + desStr.substring(20, 24));
        Text desThirdWord = new Text(this.createLabelText(des).getText() + "[4 to 7] <- " + desStr.substring(24, 28));
        Text desFourthWord = new Text(this.createLabelText(des).getText() + "[0 to 3] <- " + desStr.substring(28, 32));
        ...
        zeroExtended.setY(posY + 160 + desRec.getHeight() + 45);
