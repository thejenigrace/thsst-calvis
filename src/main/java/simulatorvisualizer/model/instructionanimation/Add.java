...
//        tab.setContent(root);
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            plusTransition.fromXProperty().bind(desRectangle.translateXProperty()
                    .add(desRectangle.getLayoutBounds().getWidth() + 110 + augendRectangle.getLayoutBounds().getWidth() + 35));
            ...
            srcLabelTransition.fromXProperty().bind(srcRectangle.translateXProperty()
                    .add(desRectangle.getLayoutBounds().getWidth() + 110 + augendRectangle.getLayoutBounds().getWidth() + 100)
