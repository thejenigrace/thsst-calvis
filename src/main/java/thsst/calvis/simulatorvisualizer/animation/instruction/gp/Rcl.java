 ...
 */
public class Rcl extends CalvisAnimation {
    ...
    public void animate(ScrollPane tab) {
        ...
        Text reminder = timeFunc.generateText(new Text("*Carry Flag is now part of the whole rotation"), 20, "#5d8aa8", FontWeight.NORMAL, "System");
        parent.add(reminder);
        if(counter == 0)
            counter = 1;
