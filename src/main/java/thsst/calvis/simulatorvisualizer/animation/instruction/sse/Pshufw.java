 ...
 */
public class Pshufw extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        Text desFirstWord = new Text(this.createLabelText(des).getText() + "[0 to 3] <- " + desStr.substring(12, 16));
        Text desSecondWord = new Text(this.createLabelText(des).getText() + "[4 to 7] <- " + desStr.substring(8, 12));
        Text desThirdWord = new Text(this.createLabelText(des).getText() + "[8 to 11] <- " + desStr.substring(4, 8));
        Text desFourthWord = new Text(this.createLabelText(des).getText() + "[12 to 15] <- " + desStr.substring(0, 4));
