 ...
 */
public class Fist extends CalvisAnimation {
    ...
    public void animate(ScrollPane tab) {
        ...
        Text label = new Text("Convert the value in the ST(0) register to a signed integer and store the result in " + tokens[0].getValue());
        label.setX(X);
        label.setY(Y);
