 ...
 */
public class Cvtps2pd extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            String description = "DESTINATION[63:0] <- Convert Single Precision to Double Precision Floating Point ( SOURCE[31:0] )\n"
                    + "DESTINATION[127:64] <- Convert Single Precision to Double Precision Floating Point ( SOURCE[63:32] )";
