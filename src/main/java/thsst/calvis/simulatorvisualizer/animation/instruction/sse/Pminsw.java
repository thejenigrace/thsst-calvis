 ...
 */
public class Pminsw extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        int operationSize = 4;
        Text sign = timeFunc.generateText(new Text("Return Min Value Using Source and Destination Operand (Signed)" ), 20, "#98777b");
