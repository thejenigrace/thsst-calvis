 ...
 */
public class Cvttps2pi extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            String srcValueString = this.getSubLowerHexValueString(tokens[1], registers, memory,
                    srcBitSize, srcHexSize/2);
            String srcValueChop = this.chopHexValue(srcValueString, srcHexSize/4);
