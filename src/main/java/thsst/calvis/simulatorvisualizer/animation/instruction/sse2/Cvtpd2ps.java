 ...
 */
public class Cvtpd2ps extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            // DESTINATION == SOURCE IF XMM REGISTER = 128, ELSE MEMORY = 128
            int desBitSize = 128;
            int desHexSize = desBitSize / 4;

            String description = "DESTINATION[31:0] <- Convert Double Precision to Single Precision Floating Point ( SOURCE[63:0] )\n"
                    + "DESTINATION[63:32] <- Convert Double Precision to Single Precision Floating Point ( SOURCE[127:64] )\n"
            ...
            String desValueHigherString = desValue.substring(0, desHexSize/2);
            String desValueLowerString = desValue.substring(desHexSize/2, desHexSize);
            String desValueLowerChop = this.chopHexValue(desValueLowerString, desHexSize/4);
            Text desValueText = new Text(X, Y, desValueHigherString
                    + "       " + desValueLowerChop);
            ...
            String srcValueChop = this.chopHexValue(srcValueString, desHexSize/2);
