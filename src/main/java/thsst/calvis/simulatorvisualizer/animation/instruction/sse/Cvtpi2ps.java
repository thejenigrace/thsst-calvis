 ...
 */
public class Cvtpi2ps extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            String desValueString = this.getSubLowerHexValueString(tokens[0], registers, memory,
                    desBitSize, desHexSize/2);
            String desValueChop = this.chopHexValue(desValueString, srcHexSize/2);
