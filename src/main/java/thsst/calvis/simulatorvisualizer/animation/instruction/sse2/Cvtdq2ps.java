 ...
 */
public class Cvtdq2ps extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            String description = "DESTINATION[31:0] <- Convert Integer to Single Precision Floating Point ( SOURCE[31:0] )\n"
                    + "DESTINATION[63:32] <- Convert Integer to Single Precision Floating Point ( SOURCE[63:32] )\n"
                    + "DESTINATION[95:64] <- Convert Integer to Single Precision Floating Point ( SOURCE[95:64] )\n"
                    + "DESTINATION[127:96] <- Convert Integer to Single Precision Floating Point ( SOURCE[127:96] )";
            ...
            if(srcValueString.length() != desHexSize)
