 ...
 */
public class Fsincos extends CalvisAnimation {
    ...
    public void animate(ScrollPane tab) {
        ...
        Text label = new Text("Compute both the approximate sine and cosine of the source operand in register ST(0), store the sine in ST(0), and push the cosine onto the top of the FPU register stack. The source operand must be given in radians and must be within the range −263 to +263.\n");
        label.setX(X);
        label.setY(Y);
        ...
        Text label0 = new Text("FCOS(ST0): ");
        Text label0a = new Text("FSIN(ST0): ");
