 ...
 */
public class Fldcw extends CalvisAnimation {
...
//                resValue = new Text(registers.get("ST0"));
            ...
            case 1:
                ...
                try{
                    desStr = memory.read(src, 16);
                } catch(MemoryReadException e){
                    e.printStackTrace();
                }
                desLabel = this.createLabelText(src);
                sourceStr = finder.getRegister("CONTROL");
                srcLabel = this.createLabelText("CONTROL REGISTER");
//                resLabel = this.createLabelText("ST0");
