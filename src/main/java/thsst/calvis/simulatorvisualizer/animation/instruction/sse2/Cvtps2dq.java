 ...
 */
public class Cvtps2dq extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            // DESTINATION BIT SIZE == SOURCE BIT SIZE
            int desBitSize = 128;
            int desHexSize = desBitSize / 4;

            String description = "DESTINATION[31:0] <- Convert Single Precision Floating Point to Integer ( SOURCE[31:0] )\n"
                    + "DESTINATION[63:32] <- Convert Single Precision Floating Point to Integer ( SOURCE[63:32] )\n"
                    + "DESTINATION[95:64] <- Convert Single Precision Floating Point to Integer ( SOURCE[95:64] )\n"
                    + "DESTINATION[127:96] <- Convert Single Precision Floating Point to Integer ( SOURCE[127:96] )";
            ...
            String desValueChop = this.chopHexValue(desValueString, desHexSize/4);
            ...
            String srcValueChop = this.chopHexValue(srcValueString, desHexSize/4);
...
//            operandText.setFont(Font.font(48));
            ...
            desValueTransition.fromXProperty().bind(desRectangle.translateXProperty()
                    .add((desRectangle.getLayoutBounds().getWidth()
                            - desValueText.getLayoutBounds().getWidth()) / 2 + 10));
            ...
            srcValueTransition.fromXProperty().bind(desRectangle.translateXProperty()
                    .add(desRectangle.getLayoutBounds().getWidth() + X + 10)
                    .add((desRectangle.getLayoutBounds().getWidth()
