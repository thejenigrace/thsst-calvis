 ...
 */
public class F2xm1 extends CalvisAnimation {
    ...
    public void animate(ScrollPane tab) {
        ...
        Text label = new Text("Compute the exponential value of 2 to the power of the source operand minus 1 [2ST(0)-1]. The source operand is located in register ST(0) and the result is also stored in ST(0). The value of the source operand must lie in the range –1.0 to+1.0. If the source value is outside this range, the result is undefined.");
        label.setX(X);
        label.setY(Y);
