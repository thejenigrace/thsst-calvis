 ...
 */
public class Fsin extends CalvisAnimation {
    ...
    public void animate(ScrollPane tab) {
        ...
        Text label = new Text("Compute an approximation of the sine of ST(0) and store the result in ST(0).");
        label.setX(X);
        label.setY(Y);
