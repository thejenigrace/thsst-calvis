 ...
 */
public class Cvtpd2dq extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            String description = "DESTINATION[31:0] <- Convert Double Precision Floating Point to Integer ( SOURCE[63:0] )\n"
                    + "DESTINATION[63:32] <- Convert Double Precision Floating Point to Integer ( SOURCE[127:64] )\n"
