 ...
 */
public class Movq2dq extends CalvisAnimation {
...
//        tab.setContent(root);
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            srcLabelText.setText("QuadWord Zero Extension + " + srcLabelText.getText());
            srcValueText.setText("0x0000000000000000" + srcValueText.getText().substring(2));
