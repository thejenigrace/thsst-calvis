 ...
 */
public class Movdq2q extends CalvisAnimation {
...
//        tab.setContent(root);
        ...
        Rectangle srcRectangle = this.createRectangle(tokens[1], 200, height);
        ...
        if ( desRectangle != null && srcRectangle != null ) {
            ...
            srcValueText.setText("0x" + srcValueText.getText().substring(18, 34));
            srcLabelText.setText("Discard Upper QuadWord of " + srcLabelText.getText());
            srcLabelText.setWrappingWidth(srcRectangle.getLayoutBounds().getWidth() - 20);
            desLabelText.setX(100);
            desLabelText.setY(100);
            desLabelText.setWrappingWidth(desRectangle.getLayoutBounds().getWidth() - 20);

            desValueText.setX(100);
            desValueText.setY(105);
