 ...
 */
public class Fxrstor extends CalvisAnimation {
    ...
    public void animate(ScrollPane scrollPane) {
        ...
        String notesStr = "Additional Notes: \n" +
                "\nStored flags from " + tokens[0].getValue() + " are to be placed in C0, C1, C2 and C3.";
...
//                resValue = new Text(registers.get("ST0"));
            ...
            case 1:
                ...
                desStr = "Restores the current State of the FF:\n" +
                         "x87 Floating Point Unit Registers and States\n" +
                         "MMX Registers\n" +
                         "XMM Registers\n" +
                         "MXSCR Register\n";
                        desLabel = this.createLabelText("RESTORE USING " + src.getValue() + ":");
//                resLabel = this.createLabelText("ST0");
