...
import thsst.calvis.configuration.model.errorlogging.RegisterFileErrorInvalidMessage;
import thsst.calvis.configuration.model.errorlogging.RegisterFileErrorMissingMessage;
import thsst.calvis.configuration.model.errorlogging.RegisterInvalid;
import thsst.calvis.configuration.model.errorlogging.RegisterMissing;
...
public class HandleConfigFunctions {
    ...
    public static ArrayList<String> checkIfMissing(String[] strArr) {
        ArrayList<String> missingArr = new ArrayList<>();
        for ( int x = 0; x < strArr.length; x++ ) {
            if ( strArr[x].isEmpty() ) {
                switch ( x ) {
                    case 0:
                        missingArr.add(new RegisterFileErrorMissingMessage(RegisterMissing.missingSourceRegister)
                                .generateMessage());
                        break;
                    case 1:
                        missingArr.add(new RegisterFileErrorMissingMessage(RegisterMissing.missingNewRegister)
                                .generateMessage());
                        break;
                    case 2:
                        missingArr.add(new RegisterFileErrorMissingMessage(RegisterMissing.missingRegisterSize)
                                .generateMessage());
                        break;
                    case 3:
                        missingArr.add(new RegisterFileErrorMissingMessage(RegisterMissing.missingRegisterType)
                                .generateMessage());
                        break;
                    case 4:
                        missingArr.add(new RegisterFileErrorMissingMessage(RegisterMissing.missingRegisterStartIndex)
                                .generateMessage());
                        break;
                    case 5:
                        missingArr.add(new RegisterFileErrorMissingMessage(RegisterMissing.missingRegisterEndIndex)
                                .generateMessage());
                        break;
                    default:
                }
    ...
    public static ArrayList<String> checkForInvalidInput(String[] strArr) {
        ArrayList<String> invalidArr = new ArrayList<>();
        for ( int x = 0; x < strArr.length; x++ ) {
...
//                        break;
                    case 2:
                        ...
                        break;
                    case 3:
                        invalidArr.add(new RegisterFileErrorInvalidMessage(RegisterInvalid.invalidRegisterType)
                                .generateMessage());
                        break;
                    case 4:
                        invalidArr.add(new RegisterFileErrorInvalidMessage(RegisterInvalid.invalidRegisterStartIndex)
                                .generateMessage());
                        break;
                    case 5:
                        invalidArr.add(new RegisterFileErrorInvalidMessage(RegisterInvalid.invalidRegisterEndIndex)
                                .generateMessage());
                        break;
                }
            }
