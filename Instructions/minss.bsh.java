execute(des, src, registers, memory) {
    ...
    if(des.isRegister()) {
        ...
        resultingHexAdd = c.hexZeroExtend(c.SinglePrecisionFloatingPointToHexSingle(floatValuesResult[0]), 8)
                          + c.hexZeroExtend(c.SinglePrecisionFloatingPointToHexSingle(floatValuesResult[1]), 8)
                          + c.hexZeroExtend(c.SinglePrecisionFloatingPointToHexSingle(floatValuesResult[2]), 8)
                          + c.hexZeroExtend(c.SinglePrecisionFloatingPointToHexSingle(floatValuesResult[3]), 8);
