execute(des,src,registers,memory){
		...
		ef.setOverflowFlag(c.checkOverflowAdd(biX.toString(2).charAt(0),biY.toString(2).charAt(0), resultingValue.charAt(0)));
		}
		}
		else if(des.isMemory()){
		...
		memory.write(des,c.binaryToHexString(resultingValue, src), registers.getBitSize(src));
		EFlags ef=registers.getEFlags();
		BigInteger biC = new BigInteger(numberOfF,16);
