execute(des, src, registers, memory) {
  ...
  if( des.isRegister() && registers.getBitSize(des) == 16 ) {
    if( src.isRegister() && registers.getBitSize(src) == 8 ) {
      System.out.println("MOVZX r16, r8");
      ...
      System.out.println("MOVZX r16, m8");
    ...
    if( src.isRegister() && registers.getBitSize(src) == 16 ) {
      System.out.println("MOVZX r32, r16");
      ...
      System.out.println("MOVZX r32, r8");
      ...
      System.out.println("MOVZX r32, m16");
